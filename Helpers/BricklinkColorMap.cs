...
namespace brickapp.Helpers
{
    ...
    public static class BricklinkColorMap
    {
        private static readonly Dictionary<int, string> _idToName = new()
        {
            ...
            // Solid (excerpt incl. all shown in guide list chunks)
            { 1, "White" },
            { 49, "Very Light Gray" },
        ...
        public static string? GetBrickColorName(int bricklinkColorId)
            => _idToName.TryGetValue(bricklinkColorId, out var name) ? name : null;

        public static bool IsNotApplicable(int bricklinkColorId) => bricklinkColorId == 0;
    }
}
