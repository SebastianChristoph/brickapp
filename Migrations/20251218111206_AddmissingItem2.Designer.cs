...
namespace brickapp.Migrations
{
    ...
    [Migration("20251218111206_AddmissingItem2")]
    partial class AddmissingItem2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.MissingItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("WantedListItemId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Data.Entities.MissingItem", b =>
                {
                    b.HasOne("Data.Entities.Mock", null)
                        .WithMany("MissingItems")
                        .HasForeignKey("MockId");

                    b.HasOne("Data.Entities.WantedListItem", null)
                        .WithMany("MissingItems")
                        .HasForeignKey("WantedListItemId");
                });
